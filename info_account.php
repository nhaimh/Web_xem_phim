    ...
    <div id="wrapper">
            ...
            <form method="post" id="form-update" name="form-update" class="form-horizontal" action="" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" class="form-control" name="username" id="update-username"
                            value="<?php echo htmlentities($received_name); ?>">
                        <label class="notifyerror" style="visibility: hidden; height: 0px" id="usernameerror">Tên tài
                            khoản chỉ bao gồm ký tự a-z, A-Z và số</label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        ...
                        <label class="notifyerror" style="visibility: hidden; height: 0px" id="passworderror">Mật khẩu
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        ...
                        <label class="notifyerror" style="visibility: hidden; height: 0px" id="password1error">Mật khẩu
                            phải bao gồm chữ thường, chữ hoa và số, độ dài tối thiểu 8 ký tự</label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" class="form-control" name="fullname" id="update-fullname"
                            value="<?php echo htmlentities($received_fullname); ?>">
                        <label class="notifyerror" style="visibility: hidden; height: 0px" id="fullnameerror">Tên chỉ
                            bao gồm các chữ cái</label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7"><input type="email" class="form-control" name="email" id="update-email"
                            value="<?php echo htmlentities($received_email); ?>">
                        <label class="notifyerror" style="visibility: hidden; height: 0px" id="emailerror">Email không
                            đúng định dạng name@domain</label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="date" class="form-control" name="birthday" id="birthday"
                            value="<?php echo htmlentities($received_birthday); ?>">
                    </div>
                </div>
              ...
              <input type="hidden" name="update[password_md5]" value=""> -->
                    <button type="submit" class="btn btn-primary" id="button_update" name="button_update">Cập
                        nhật</button>
                </div>
      ...
      ?>
        ...
        button_update.onclick = function() {
            ...
            if (validName && validPass && validNewPass1 && validNewPass2 && validFullname && validEmail &&
                validBirthday) {
                return true;
            }
            return false;
