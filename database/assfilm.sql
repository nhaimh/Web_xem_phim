...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 11, 2021 at 05:41 AM
...
CREATE TABLE IF NOT EXISTS `film` (
  ...
  `linkfilm` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
(7, 'ĐẤU LA ĐẠI LỤC', 'Dau La Dai Luc (2018)', 'Tập 28 ', 'Không xác định', 'Không xác định', 6, 1, 5, 2015, 'images/p5.png', 'Một đại lục không hề yên bình, một cuộc sống đầy hiểm nguy, phiêu lưu nhưng cũng không kém phần lãng mạn. tình yêu, thù hận, trách nhiệm… Tiếp bước những tiền bối đi trước, Hoắc Vũ Hạo và đời sau sử lai khắc thất quái, bằng niềm tin nhiệt huyết tuổi trẻ đã gây dựng lại đường môn tái lập những huy hoàng xưa kia của các tiền bối đi trước…', 25, 2309, 'Không xác định', '1tS74Q-X9vlLSy1S8-9e--p5Vdgf5qU8h'),
...
(9, 'vietquoc1416', 'Quoc Viet', '$2y$10$sXJABX.4YSrKSY2nTWhQfu4/kzi3F2z2lgKWPkt61KgktxAkzeCdy', 'vietquoc1416@gmail.com', '2000-01-10', 'male', 99),
(10, 'user1', 'Usernumberone', '$2y$10$mAh1X6Hd0PQDezZxgmPOP.q5rhoJ.G5LTDrrS652Mu5zBsectWU86', 'user1@gmail.com', '2000-12-02', 'male', 20),
(11, 'sonhuynh', 'Huynh Son', '$2y$10$GGptkNlsK0L7cPDhaynqxe7deRxcuSQhAkGsGBJ44QwzsyfL8hN4K', 'ronaldo211234@gmail.com', '2021-12-11', 'male', 99);
